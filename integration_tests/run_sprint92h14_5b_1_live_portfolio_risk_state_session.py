...
def predecessor_journal_path_for(
    ...
    H14.5b.1 must never ignore an open H14.5a
...
def refresh_runtime_portfolio_state(
    *,
    ...
    if (
        ...
        raise RuntimeError(
            "RUNTIME_GLOBAL_SHADOW_POSITION_"
            "LIMIT_VIOLATED"
        )
...
def main():
    ...
    try:
        ...
        #
        # H14.5a is frozen evidence and is NEVER
        # written by this runner.
        #
        # If an H14.5a position is still open,
        # H14.5b.1 must not start a fresh portfolio
        ...
        print(
            "PREDECESSOR_H14_5A_OPEN_POSITION_COUNT",
            predecessor_portfolio_recovery
            .open_position_count,
        )

        print(
            "PREDECESSOR_H14_5A_TOTAL_RISK_PERCENT",
            predecessor_snapshot
            .total_risk_percent,
        )
        ...
        # already been carried into the H14.5b.1
        # journal namespace.
        #
        ...
        report = {
            ...
            "mode": (
                "LIVE_POLICY_MULTI_SYMBOL_"
                "PORTFOLIO_RISK_STATE_SINGLE_POSITION_SHADOW_SESSION"
            ),
            "symbols": list(
                symbols
            ),
