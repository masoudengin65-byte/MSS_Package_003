...
def main():
    ...
    try:
        ...
        #
        # H14.5b.1 is frozen evidence and is NEVER
        # written by this runner.
        #
        # If an H14.5b.1 position is still open,
        # H14.5c must not start a fresh portfolio
        ...
        print(
            "PREDECESSOR_H14_5B_1_OPEN_POSITION_COUNT",
            predecessor_portfolio_recovery
            .open_position_count,
        )

        print(
            "PREDECESSOR_H14_5B_1_TOTAL_RISK_PERCENT",
            predecessor_snapshot
            .total_risk_percent,
        )
        ...
        # already been carried into the H14.5c
        # journal namespace.
        #
        ...
        print(
            "PREDECESSOR_H14_5B_1_SUPERSEDED",
            (
                portfolio_continuity_result.reason
                ==
                "CURRENT_SUPERSEDES_PREDECESSOR"
        ...
        report = {
            ...
            "mode": (
                "LIVE_POLICY_MULTI_SYMBOL_"
                "SAFETY_GOVERNOR_SINGLE_POSITION_SHADOW_SESSION"
            ),
            "symbols": list(
                symbols
            ),
